...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
                    // WebSecurityConfigurerAdapter :올해 3월에 운명함 실행은됨
    @Autowired
    private MemberService memberService;
    @Override // 인증(로그인) 관련 메소드 정의
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and() // 기능구분
                          ...
                          .userInfoEndpoint() // Endpoint : 소셜 회원정보를 받는곳
                          .userService(memberService) ;// 해당서비스 loadUser 메소드 구현
...
/*
    ...
    시큐리티 사용방법
        ...
        //2. 시큐리티 커스텀 [ 기본 설정값 변경 ]
            @Configuration : 컴포넌트 시리즈 [ @Controller , @Service , @Entity, @Configuration]
           1.WebSecurityConfigurerAdapter 클래스 상속받아서 커스텀 클래스 선언
                1.configure(HttpSecurity http) : http 보안메소드
                2.

    시큐리티 기본값
        1. 해당 프로젝트의 모든 URL 잠긴다.
            -> 커스텀 : http 권한 없애기
        2. login html  제공 -> 커스텀 login 페이지 변경 가능
